            ...
            <main class="row overflow-auto">
                <div class="col pt-4">
                    ...
                    <form action="<?php echo base_url('staff/add_staff') ?>" method="post">
                        <div class="modal fade" id="Add_Staff" data-bs-backdrop="static" data-bs-keyboard="false"
                                ...
                                <div class="modal-content">
                                    ...
                                    <?php endif;?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="staff_Username" class="form-control" value="<?= old('staff_Username'); ?>">
                                            <?php if($validation_errors->getError('staff_Username')):?>
                                                <div class="alert alert-danger mt-2"><?= $validation_errors->getError('staff_Username') ?></div>
                                            <?php endif;?>
                                        </div><br>

                                        <div class="form-group">
                                            <label for="staff_Password" class="form-label">Password</label>
                                            <input type="password" id="staff_Password" name="staff_Password" class="form-control" value="<?= old('staff_Password'); ?>">
                                            <input type="checkbox" onclick="staffPassword()">Show Password
                                            <?php if($validation_errors->getError('staff_Password')):?>
                                                <div class="alert alert-danger mt-2"><?= $validation_errors->getError('staff_Password') ?></div>
                                            <?php endif;?>
                                        </div><br>
                    ...
                    <form action="<?php echo base_url('staff/update_staff/'.$row['staff_ID']); ?>" method="post">
                        <div class="modal fade" id="Edit_Staff<?= $row['staff_ID']; ?>" data-bs-backdrop="static"

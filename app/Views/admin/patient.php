         ...
         <main class="row overflow-auto">
            <div class="col pt-4">
               ...
               <form action="<?php echo base_url('patient/add_patient') ?>" method="post">
                  <div class="modal fade modal-lg" id="Add_Patient" data-bs-backdrop="static" data-bs-keyboard="false"
               ...
               <form action="<?php echo base_url('patient/update_patient/'.$row['pat_ID']); ?>" method="post">
                  <div class="modal fade modal-lg" id="Edit_Patient<?= $row['pat_ID']; ?>" data-bs-backdrop="static" data-bs-keyboard="false"
                     tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              ...
                              <div class="row g-3">
                                 ...
                                 <div class="col">
                                    <label for="pat_FamHistory" class="form-label">Family History</label>
                                    <textarea rows="3" name="pat_FamHistory" class="form-control"><?php if(empty(set_value('pat_FamHistory'))):?><?= $row['pat_FamHistory'] ?><?php else:?><?= set_value('pat_FamHistory') ?><?php endif;?></textarea>                                      
                                    <?php if($validation_errors->getError('pat_FamHistory')):?>
                                       <div class="alert alert-danger mt-2"><?= $validation_errors->getError('pat_FamHistory') ?></div>
                                    <?php endif;?>
                                 </div><br>
